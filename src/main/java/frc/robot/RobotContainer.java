...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        controller.b().onTrue(new MoveForwardCommand(drive, Degrees.of(0), MetersPerSecond.of(.1), Meters.of(Constants.WHEEL_CIRCUMFERENCE))); // should end up being exactly one rotation or something is wrong with values probaly constants will have to test pid first
